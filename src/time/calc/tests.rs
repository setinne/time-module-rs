...
mod tests {
    ...
    fn test_utc_to_fulltime_positive() {
        let ft = utc_to_fulltime(0, 0, 28800);  // UTC 0 + 8h = 1970-01-01 08:00
    ...
    fn test_utc_to_fulltime_negative() {
        let ft = utc_to_fulltime(0, 0, -28800);  // UTC 0 - 8h = 1969-12-31 16:00
    ...
    fn test_2038_timestamp() {
        let ft = utc_to_fulltime(2147483647, 0, 0);  // 2038-01-19 03:14:07 UTC
