...
class TimeModule
{
    ...
    static void Main()
    {
        ...
        if (len > 0)
            Console.WriteLine($"时间: {System.Text.Encoding.UTF8.GetString(buf, 0, len)}");
    }
}
```
...
| 函数名 | 返回值 | 说明 |
|--------|--------|------|
| `api_GetVersion()` | `int` | 获取 DLL 版本号（如 0x000209 表示 v0.2.9） |
...
| 文件 | 架构 | 大小 |
|------|------|------|
| [time_module_normal_x64.dll](https://github.com/setinne/time-module-rs/releases/latest) | 64位 | ~1,072 KB |
| [time_module_normal_x86.dll](https://github.com/setinne/time-module-rs/releases/latest) | 32位 | ~1,074 KB |
| [time_module_upx_x64.dll](https://github.com/setinne/time-module-rs/releases/latest) | 64位 (UPX) | ~375 KB |
| [time_module_upx_x86.dll](https://github.com/setinne/time-module-rs/releases/latest) | 32位 (UPX) | ~405 KB |
